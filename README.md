...
## Usage
    ...
    a file with the same name but ended in -p is created after conversion.
...
AMV Format - Actions 1.8 inch:  ffmpeg -i source.mp4 -vf "scale=-2:128, crop=160:128" -r 14 -pix_fmt yuv420p -c:v amv -c:a adpcm_ima_amv -ac 1 -ar 22050 -block_size 1575 dest.amv  # portable mp3 player - video converter tools
...
It's used as sample a fragment of 30 seconds of the Creative Commons video Big Buck Bunnt https://en.wikipedia.org/wiki/Big_Buck_Bunny
